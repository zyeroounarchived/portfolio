...
The environment monitors global keystroke inputs. The interface will react if the correct sequences are entered.

    [ Cmd + K ] — Expose raw JSON payload

    [ T ] — Render background physics nodes

    [ G ] — Reveal system telemetry

    [ S ] — Reformat DOM to screenplay standard

    [ V ] — Initialize visual dialogue interface

    [ C ] — Override system palette
